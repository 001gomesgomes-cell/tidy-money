...
- 16:54 Conjunto de anúncios configurado: localização Estados Unidos (removido Angola, o padrão da conta), idade 18+, posicionamentos Advantage+, programação 24/09/2026 16:41 → 04/10/2026 16:41 (GMT+1), orçamento total da campanha 100 USD (≈10 USD/dia). Checkout Whop direto validado: https://whop.com/checkout/plan_NekLZzRsRfk6W (produto, 12 USD, pagamento único); botões do site apontam para lá.
- 19:17 Página do Facebook "Tidy Money" criada (ID 61594953772027 / page_id 1320499011149651) com logótipo e capa gerados localmente; selecionada como identidade do anúncio A1 (Instagram: usar a Página). Utilizador pediu para deixar os anúncios para o fim e tratar do resto primeiro.
- 19:17 Instabilidade: extensão Claude in Chrome caiu ~6 vezes nesta sessão; o Gestor de Anúncios recarregado perdeu o passo do assistente de criativo (mídia/texto) — a repetir quando voltar aos anúncios. Classificador do modo automático indisponível momentaneamente (upload de foto na Página adiado).
